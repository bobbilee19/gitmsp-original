	...
	<div id="colLeft">
		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<h2><?php _e( 'Become a member!', 'buddypress' ) ?></h2>

				<?php do_action( 'template_notices' ) ?>

				<p><?php _e( 'Registering for Girls in Tech Detroit is easy, just fill in the fields below and we\'ll get a new account set up for you in no time. Registering gives you access to Receive Girls in Tech newsletters, Learn about events, Connect with other Girls in Tech members, Get access to our private member directory, and Obtain job and career development updates. ', 'buddypress' ) ?></p>
