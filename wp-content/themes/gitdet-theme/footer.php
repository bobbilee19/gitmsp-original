			...
			<div id="footerWidgetsInner">
				...
				<div id="copyright">
					<?php if (get_option('boldy_copyright') <> ""){
						...
						<div id="site5bottom"><a href="http://gk.site5.com/t/239">Site5.com | Experts in Web Hosting.</a></div><br />
                Website Development by <a href="http://www.shwapo.com" target="_blank"><img src="http://www.girlsintechdet.com/wp-content/themes/boldy/images/shwapo-logo.png" width="75" height="11" alt="Shwapo - Website Development" /></a></div>
				<!-- END COPYRIGHT -->						
				</div>
