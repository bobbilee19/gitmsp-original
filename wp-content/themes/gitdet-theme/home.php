	  ...
	  <div id="slider">
	   ...
	   <div id="blurb">
			...
			<?php
			    ...
			    echo '<a href=""><img src="http://www.gitmsp.org/wp-admin/images/but_blurb.png" alt="Join Us!"></a>';
	   ...
	   <!-- begin home boxes -->
		...
		<div id="homeBoxes" class="clearfix">
			...
			<div class="homeBox">
				...
				<?php echo apply_filters('the_content', $box2->post_content);?><div class="clear"></div>
				<a href="<?php echo get_option('boldy_home_box2_link')?>"><strong>See All Events &raquo;</strong></a>
			</div>
			<div class="homeBox last">
				<h2><?php echo $box3->post_title?></h2>
				<?php echo apply_filters('the_content', $box3->post_content);?>
				<a href="<?php echo get_option('boldy_home_box3_link')?>"><strong>View All &raquo;</strong></a>
			</div>
		</div>
		<?php }?>
		<!-- end home boxes -->
